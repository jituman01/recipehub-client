    ...
    return (
        <div className="space-y-6 mt-6 bg-transparent text-foreground">
            ...
            {!isPremium ? (
                ...
                <Card className="border border-orange-500/20 bg-gradient-to-r from-yellow-500/10 via-yellow-400/20 to-transparent relative overflow-hidden shadow-sm" radius="lg">
                    <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-6 z-10">
                            <div className="space-y-2">
                                <div className="flex space-x-4">
                                <span>
                                    <GiQueenCrown className="text-orange-500 dark:text-orange-400 w-18 h-18 " />
                                </span>
                                    <div>
                                        <h3 className="text-xl font-bold text-foreground dark:text-white flex items-center gap-2">
                            ...
                            <p className="text-default-500 dark:text-slate-400 text-xs max-w-xl leading-relaxed">
                                Thank you for being a premium member, <span className="font-bold text-orange-500">{user?.name}</span>! Enjoy unlimited recipe creations, prioritized search results, and full elite features.
                            </p>
                                    </div>
                            </div>
                        </div>
                        <div  className=" text-orange-600 font-bold  shrink-0 opacity-100 flex items-center gap-1.5" radius="lg">
