...
export default function UserPricingPage() {
  const plans = [
    ...
    },
    {
      ...
      period: '',
      description:
        'For culinary schools, restaurants, and professional brands.',
      features: [
  ...
  return (
    <main className="bg-background text-foreground min-h-screen">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20">
        <div className="grid gap-8 lg:grid-cols-3 items-stretch">
          {plans.map(plan => (
            ...
            >
              {plan.popular && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-yellow-500 px-4 py-1 text-xs font-bold text-white tracking-wide shadow-sm">
                  Most Popular Plan
                </div>
              )}
              ...
              <div>
                ...
                <p className="mt-2.5 text-sm text-default-400 min-h-[40px]">
                  {plan.description}
                </p>
                ...
                <div className="mt-6 flex items-baseline">
                  ...
                  <span className="text-sm font-medium text-default-400 ml-1">
                    {plan.period}
                  </span>
                </div>
                ...
                <ul className="mt-8 space-y-3.5 border-t border-divider pt-6">
                  {plan.features.map(feature => (
                    ...
                    >
                      <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-yellow-50 text-yellow-500 dark:bg-yellow-950/50">
              ...
              <div className="mt-8">
                ...
                plan.name === 'Starter Plan' ? (
                  <Button className="mt-8 w-full text-black dark:text-white bg-transparent ">
                    Not Available
                  </Button>
                ) : (
                  <form action={'/api/subscription'} method="POST">
                    <Button
                      type="submit"
                      className="mt-8 w-full font-medium bg-yellow-500 text-white shadow-md shadow-yellow-500/20 hover:bg-yellow-600"
                    >
                      Upgrade to Pro
                    </Button>
                  </form>
      ...
      <section className="border-t border-divider bg-content1/50 backdrop-blur-md">
        <div className="mx-auto max-w-7xl px-4 py-20">
          <h2 className="text-center text-2xl font-bold md:text-3xl">
            Why Publish On RecipeHub?
          </h2>

          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-divider bg-background p-5 shadow-xs">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-yellow-50 text-yellow-500 dark:bg-yellow-950/50">
                <ChefHat size={20} />
              </div>
              <h3 className="font-bold text-base">Foodie Community</h3>
              <p className="mt-2 text-xs text-default-400 leading-relaxed">
                Reach thousands of active food lovers hunting for new kitchen
            ...
            <div className="rounded-2xl border border-divider bg-background p-5 shadow-xs">
              ...
              <p className="mt-2 text-xs text-default-400 leading-relaxed">
                Build trust with verified user profile badges and ensure
                copyright protection of your recipes.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-divider bg-background p-5 shadow-xs">
              ...
              <p className="mt-2 text-xs text-default-400 leading-relaxed">
                Deep dive and track how many users view, save, or favorite your
                custom recipes instantly.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-divider bg-background p-5 shadow-xs">
              ...
              <p className="mt-2 text-xs text-default-400 leading-relaxed">
                Easily organize dynamic categories, ingredient scaling, and
                manage cooking step timelines.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-20">
        <div className="rounded-3xl border border-yellow-100 bg-gradient-to-br from-yellow-500/10 to-transparent p-8 sm:p-12 text-center dark:border-yellow-950/30">
          <h2 className="text-2xl font-bold md:text-3xl">
            Ready to Start Cooking?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-sm text-default-400 leading-relaxed">
            Join our platform ecosystem today and unlock the perfect creation
            flow for your food recipes and culinary stories.
          </p>

          <Button className="mt-8 bg-yellow-500 hover:bg-yellow-600 text-white font-bold h-11 px-8 rounded-xl shadow-lg shadow-yellow-500/10 active:scale-95">
