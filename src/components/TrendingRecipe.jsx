...
useEffect(() => {
  const ctx = gsap.context(() => {
    ...
    gsap.fromTo(".trending-image", 
      { opacity: 0, rotate: -30, scale: 0.5, y: 100 }, 
      { 
        opacity: 1, 
        rotate: 0, 
        scale: 1, 
  ...
  return (
    <section ref={sectionRef} className="relative w-full py-20 md:py-32 overflow-hidden transition-colors duration-300">
      ...
      <div className="relative max-w-[1400px] mx-auto bg-gradient-to-r from-yellow-400 to-yellow-400 dark:from-yellow-500 dark:to-yellow-500 rounded-[40px] md:rounded-[50px] mx-4 p-6 md:p-12 text-stone-900 dark:text-stone-950 shadow-xl min-h-[380px] md:min-h-[400px] flex items-center transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full relative z-10">
          ...
          <div className="trending-content lg:col-span-7 space-y-5 md:space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-stone-800 dark:text-stone-900 max-w-xl font-medium leading-relaxed opacity-95">
                This stunning masterpiece has taken our platform by storm this month! Handcrafted by our top community chef, this refreshing creation balances pure nutrition with an unforgettable taste.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-stone-900/15 dark:border-stone-950/20 max-w-lg">
              ...
              <div className="space-y-1">
                ...
                <span className="text-[10px] md:text-xs font-black uppercase tracking-wider block text-stone-900 dark:text-stone-950">Views</span>
              </div>
              <div className="space-y-1">
          ...
          {/* img*/}
          <div className="trending-image lg:col-span-5 relative flex justify-center lg:justify-end min-h-[240px] lg:min-h-[350px]">
