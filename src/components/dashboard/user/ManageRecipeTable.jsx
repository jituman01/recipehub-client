                ...
                <table className="w-full min-w-[800px] text-left border-collapse ">
                    <thead>
                        <tr className="border-b border-gray-500 dark:border-white/10 bg-default-50/50 dark:bg-slate-900/40">
                            <th className="py-4 px-6 text-xs font-bold text-default-500 uppercase tracking-wider">Recipe</th>
                            <th className="py-4 px-6 text-xs font-bold text-default-500 uppercase tracking-wider">Category</th>
                            <th className="py-4 px-6 text-xs font-bold text-default-500 uppercase tracking-wider">Difficulty</th>
                            <th className="py-4 px-6 text-xs font-bold text-default-500 uppercase tracking-wider">Likes</th>
                            <th className="py-4 px-6 text-xs font-bold text-default-500 uppercase tracking-wider">Status</th>
                            <th className="py-4 px-6 text-xs font-bold text-default-500 uppercase tracking-wider">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {recipes.length === 0 ? (
                            <tr>
                                <td colSpan="6" className="py-8 text-center text-sm text-default-400 font-medium">
                                    No recipes found.
                                </td>
                            </tr>
                        ) : (
                                ...
                                >
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex items-center gap-3">
                                            <div className="w-12 h-12 rounded-xl overflow-hidden bg-default-100 relative border border-default-200 dark:border-white/10">
                                                <Image 
                                                    src={recipe.image || recipe.imageUrl || "/recipe-placeholder.png"} 
                                                    fill
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-sm font-bold text-foreground line-clamp-1">{recipe.title}</span>
                                                <span className="text-[11px] text-default-400 mt-0.5">
                                                    {recipe.createdAt ? new Date(recipe.createdAt).toLocaleDateString('en-GB') : "16/06/2026"}
                                                </span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex items-center gap-2">
                                            <button className="px-3 py-1.5 text-xs font-bold rounded-lg border border-default-200 dark:border-white/10 hover:bg-default-100 dark:hover:bg-white/5 transition-all text-foreground">
                                                View
                                            </button>
                                            <button 
